...
@Ignore
public class HiveMetastore2BootstrapTest {
    ...
    public void hiveMetastoreShouldStart() throws InterruptedException, NotFoundServiceException {
        ...
        try {
            HiveMetaStoreClient hiveClient = new HiveMetaStoreClient((HiveConf) ((BootstrapHadoop)HadoopBootstrap.INSTANCE.getService(Component.HIVEMETA_2)).getConfiguration());
