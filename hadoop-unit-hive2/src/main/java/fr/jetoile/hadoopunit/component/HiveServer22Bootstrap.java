...
public class HiveServer22Bootstrap implements BootstrapHadoop {
    final public static String NAME = Component.HIVESERVER2_2.name();

    static final private Logger LOGGER = LoggerFactory.getLogger(HiveServer22Bootstrap.class);
    ...
    public HiveServer22Bootstrap(URL url) {
        if (hiveLocalServer2 == null) {
            try {
