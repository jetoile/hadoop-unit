...
public class KnoxBootstrapTopologyTest {
    ...
    public void generatedTopology_should_be_ok_with_3_services() throws IOException {
        ...
        assertEquals(topology.trim(), "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" +
                ...
                "    <service>\n" +
                "        <role>NAMENODE</role>\n" +
                "        <url>hdfs://" + configuration.getString(KnoxConfig.HDFS_NAMENODE_HOST_CLIENT_KEY) + ":20112</url>\n" +
                "    </service>\n" +
                "    <service>\n" +
                "        <role>WEBHDFS</role>\n" +
                "        <url>http://" + configuration.getString(KnoxConfig.HDFS_NAMENODE_HOST_CLIENT_KEY) + ":50070/webhdfs</url>\n" +
                "    </service>\n" +
                "    <service>\n" +
                "        <role>WEBHBASE</role>\n" +
                "        <url>http://" + configuration.getString(KnoxConfig.HBASE_REST_HOST_CLIENT_KEY) + ":28000</url>\n" +
                "    </service>\n" +
                "</topology>");
    }
