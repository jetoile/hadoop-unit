...
public class HiveServer23Bootstrap implements BootstrapHadoop3 {
    ...
    private void loadConfig() throws BootstrapException {
        ...
        derbyDirectory = getTmpDirPath(configuration, Hive3Config.HIVE3_METASTORE_DERBY_DB_DIR_KEY);
    ...
    public void loadConfig(Map<String, String> configs) {
        ...
        if (StringUtils.isNotEmpty(configs.get(Hive3Config.HIVE3_METASTORE_DERBY_DB_DIR_KEY))) {
            derbyDirectory = getTmpDirPath(configs, Hive3Config.HIVE3_METASTORE_DERBY_DB_DIR_KEY);
        }
