...
public class YarnBootstrap3Test {
    ...
    public String getStdoutPath() throws NotFoundServiceException {
        BootstrapHadoop3 yarn = (BootstrapHadoop3) HadoopBootstrap.INSTANCE.getService("YARN3");
        String yarnName = ((Yarn3Bootstrap) yarn).getTestName();
