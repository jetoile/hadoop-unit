...
* Download it on [search.maven.org](http://search.maven.org/remotecontent?filepath=fr/jetoile/hadoop/hadoop-unit-standalone/2.10/hadoop-unit-standalone-2.10.tar.gz)
* Unzip it
* Edit file:
