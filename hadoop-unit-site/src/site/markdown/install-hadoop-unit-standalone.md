...
* Download it on [search.maven.org](http://search.maven.org/remotecontent?filepath=fr/jetoile/hadoop/hadoop-unit-standalone/2.7/hadoop-unit-standalone-2.8.tar.gz)
* Unzip it
* Edit files:
