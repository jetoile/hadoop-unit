...
public class HiveMetastoreBootstrap implements BootstrapHadoop {
    ...
    private HiveConf buildHiveConf() {
        ...
        hiveConf.set("fs.defaultFS", "hdfs://" + configuration.getString(HdfsConfig.HDFS_NAMENODE_HOST_CLIENT_KEY) + ":" + configuration.getInt(HdfsConfig.HDFS_NAMENODE_PORT_KEY));
