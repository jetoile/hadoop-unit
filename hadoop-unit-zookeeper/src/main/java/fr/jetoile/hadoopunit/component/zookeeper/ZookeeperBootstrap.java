 ...
 */
package fr.jetoile.hadoopunit.component.zookeeper;
...
public class ZookeeperBootstrap implements Bootstrap {
    ...
    public void loadConfig(Map<String, String> configs) {
        if (isNotEmpty(configs.get(HadoopUnitConfig.ZOOKEEPER_PORT_KEY))) {
            port = Integer.parseInt(configs.get(HadoopUnitConfig.ZOOKEEPER_PORT_KEY));
        }
        if (isNotEmpty(configs.get(HadoopUnitConfig.ZOOKEEPER_TEMP_DIR_KEY))) {
            localDir = configs.get(HadoopUnitConfig.ZOOKEEPER_TEMP_DIR_KEY);
        }
        if (isNotEmpty(configs.get(HadoopUnitConfig.ZOOKEEPER_HOST_KEY))) {
